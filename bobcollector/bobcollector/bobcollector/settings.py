"""
Django settings for bobcollector project.
...
SECRET_KEY = 'django-insecure-^0fl=b@k)fbgb$!(q)dl-di%71$!8pwn8+i2)-t=hx9==_g)e6'
...
ROOT_URLCONF = 'bobcollector.urls'
...
WSGI_APPLICATION = 'bobcollector.wsgi.application'
